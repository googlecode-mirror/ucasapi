	...
	<body>
		...
		<div class="container">
			...
			<div align="center" id="dialogoAsignar" style="visibility: hidden;">
				...
				<input id="txtActivityName" type="text"  value="" class = "inputField" title="Nombre de la actividad"/><br/><br/>

				<span class = "requiredFieldLabel" >Proyecto</span><br/>
				<input id="txtProjectName" type="text"  value="" class = "inputField" title="Proyecto al que la actividad est� asociada"/><br/><br/>

				<span class = "inputFieldLabel" >Proceso</span><br/>
				<input id="txtProcessName" type="text"  value="" class = "inputField" title="Proceso al que la actividad est� asociada"/><br/><br/>

				<span class = "requiredFieldLabel" >Responsable</span><br/>
				<input id="txtResponsibleName" type="text"  value="" class = "inputField" title="Usuario responsable de la actividad"/><br/><br/>

				<span class = "requiredFieldLabel" >Prioridad</span><br/>
				<input id="txtPriorityName" type="text"  value="" class = "inputField" title="Usuario responsable de la actividad"/><br/><br/>

				<span class = "requiredFieldLabel" >Estado</span><br/>
				<input id="txtStatusName" type="text"  value="" class = "inputField" title="Usuario responsable de la actividad"/><br/><br/>

				<span class = "inputFieldLabel" >Planificaci�n</span><br/>
				...
				<span class = "requiredFieldLabel" style = "clear:both">Descripci�n</span><br/>
