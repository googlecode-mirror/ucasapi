<html>
	...
	<body>
		...
		<div class="sessionBar">
			...
			<img id="logoutButton" title="Cerrar sesiÛn" src="<?php echo base_url(); ?>application/views/css/img/logout_button.png" />
		...
		<div class="container">
			...
			<div align="center" id="dialogoProyecto" style="visibility: hidden;">
				...
				<span class = "inputFieldLabel"><b>Fecha de finalizaci√≥n:</b></span><br/>
